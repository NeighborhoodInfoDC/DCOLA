/*******************************************
Program: Latino_age_sex_PUMA_200507.sas
Library: DCOLA
...
data pums_agesexrace0507_unweighted; 
set oladata.PUMS_200507   (keep= PWGTP PUMA AGEP RAC1P HISP SEX  
		);
...
proc summary data=pums_agesexrace0507_unweighted chartype;
      var TOTSAMP;
      class  PUMA LATINO SEX AGEGROUP;
	  weight PWGTP;
      output out=HispAgeSexPUMA0507 sumwgt=;
run;

filename fexport "D:\DCDATA\Libraries\DCOLA\Raw\HispAgeSexPUMA0507.csv" lrecl=2000;
proc export data=HispAgeSexPUMA0507
	outfile=fexport 
	dbms=csv replace;
	run;
