** program name: HMDA_incomelev_09.sas
...
%Macro wardstamps1 ;
	...
	data borrowers&year._int;
		set hmda.hmda_sum_wd02 (keep = ward2002
									...
									densubprimemrtgpurch_vli_&year.
									densubprimemrtgpurch_li_&year.
									densubprimemrtgpurch_mi_&year.
									densubprimemrtgpurch_hinc_&year.
