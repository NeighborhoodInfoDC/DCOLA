...
%Macro wardstamps1 ;
	...
	data deaths&year._int;
		set vital.deaths_sum_wd02 (keep = ward2002 deaths_violent_&year. deaths_violent_hsp_&year.) /*these are the only indicators for now, add more later*/;
		run;
...
filename fdstamps  dde  "Excel|K:\Metro\PTatian\DCData\Libraries\DCOLA\Doc\Tables\[Viodeath 09.xls]citywide!r10c&col1.:r11c&col1." /*notab*/;
...
filename fdstamps  dde  "Excel|K:\Metro\PTatian\DCData\Libraries\DCOLA\Doc\Tables\[Viodeath 09.xls]ward!r9c&col1.:r10c&col2." /*notab*/;
